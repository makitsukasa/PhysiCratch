...
namespace BoxyLib
{
	...
	public static class TouchUtil
	{
		...
		public static Vector2F GetTouchPosition2F()
		{
			Vector3 a = GetTouchPosition();
		...
		{
			return GetTouchWorldPosition( Camera.main );
		}

		public static Vector2F GetTouchWorldPosition2F( Camera camera )
		{
			Vector3 a = GetTouchWorldPosition( camera );
			return new Vector2F( a.x, a.y );
		}

		public static Vector2F GetTouchWorldPosition2F()
		{
			return GetTouchWorldPosition2F( Camera.main );
		}
